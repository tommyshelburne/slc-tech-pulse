...
const companies: Company[] = [
  ...
  },
  {
    ...
    careersUrl: 'https://www.bamboohr.com/careers',
    isHiring: true,
    isFeatured: false,
  },
  {
...
const events: Event[] = [
  ...
  },
  {
    ...
    isOnline: false,
    url: 'https://www.meetup.com/react-slc',
  ...
  },
  {
    ...
    venue: 'Podium HQ',
    isOnline: false,
    url: 'https://www.meetup.com/utah-aiml',
  ...
  },
  {
    ...
    venue: 'Lucid HQ',
    isOnline: false,
    url: 'https://www.lucidsoftware.com/events/hackathon',
  ...
  },
  {
    ...
    venue: 'BambooHR HQ',
    isOnline: false,
    url: 'https://www.bamboohr.com/events',
  ...
  },
  {
    ...
    venue: 'Domo HQ',
    isOnline: false,
    url: 'https://www.domo.com/events/developer-day',
...
const jobs: Job[] = [
  {
    id: 'lucid-junior-frontend-engineer',
    ...
    salary: '$80k–$105k',
    description:
      "Join the Lucidchart web team building the core canvas. You'll work in React + TypeScript on the rendering pipeline, collaboration features, and UI polish. Mentorship from senior engineers and a well-defined growth path to mid-level.",
    url: 'https://www.lucidsoftware.com/careers/jobs/junior-frontend',
    topics: ['React', 'TypeScript', 'Frontend'],
  ...
  },
  {
    ...
    url: 'https://www.bamboohr.com/careers/full-stack',
  ...
  },
  {
    ...
    url: 'https://adobe.com/careers/swe-ii-creative-cloud',
  ...
  },
  {
    ...
    url: 'https://www.domo.com/careers/react-developer',
  ...
  },
  {
    ...
    salary: '$120k–$155k',
    description:
      "Ship customer-facing features in the Podium messaging inbox. You'll work in React + TypeScript with heavy real-time WebSocket usage.",
    url: 'https://www.podium.com/careers/frontend-engineer',
    topics: ['React', 'TypeScript', 'Frontend'],
  ...
  },
  {
    ...
    level: 'mid',
    description:
      'Join the Canopy web platform team. React + TypeScript on the frontend, Node services on the backend. Small, product-focused team.',
    url: 'https://www.getcanopy.com/careers/software-engineer',
    topics: ['React', 'TypeScript', 'Node'],
    postedAt: '2026-04-14T00:00:00Z',
    isHighlighted: false,
    source: 'company',
  },
  {
    id: 'entrata-junior-developer',
    ...
    salary: '$75k–$95k',
    description:
      "Entry-level role on the Entrata platform. You'll contribute to the payments or leasing modules depending on team fit. New-grads and career-switchers welcome.",
    url: 'https://www.entrata.com/careers/junior-developer',
    topics: ['React', 'PHP'],
  ...
  },
  {
    ...
    salary: '$125k–$160k',
    description:
      "Ship product in the Weave app — communication features used by tens of thousands of healthcare offices. React + TypeScript, Go services.",
    url: 'https://www.getweave.com/careers/full-stack',
    topics: ['React', 'TypeScript', 'Go'],
  ...
  },
  {
    ...
    url: 'https://www.bill.com/careers/swe-ii',
    topics: ['React', 'TypeScript', 'Node'],
  ...
  },
  {
    ...
    salary: '$45/hr',
    description:
      "12-week summer internship on a Qualtrics product team. You'll ship a real feature end-to-end, pair with senior engineers, and present at the intern showcase.",
    url: 'https://www.qualtrics.com/careers/internships',
    topics: ['React', 'TypeScript'],
    postedAt: '2026-03-28T00:00:00Z',
    isHighlighted: true,
    source: 'company',
  },
  {
    ...
    url: 'https://www.mx.com/careers/junior-frontend',
  ...
  },
  {
    ...
    url: 'https://www.healthcatalyst.com/careers/swe-analytics',
  ...
  },
  {
    ...
    url: 'https://careers.vivint.com/react-node',
    topics: ['React', 'TypeScript', 'Node'],
  ...
  },
  {
    ...
    url: 'https://adobe.com/careers/workfront-swe',
    topics: ['React', 'TypeScript', 'Java'],
  ...
  },
  {
    ...
    url: 'https://claimlogiq.com/careers/junior-swe',
